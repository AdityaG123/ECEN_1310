...
int main(){
  ...
  psum = handSum(pHand,2);
  dsum = handSum(dHand,2);
  ...
  printf("-----------------------------------\n");
  printf("Dealer's First Card was ");
  printCard(d1);
